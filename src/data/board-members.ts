...
export const boardMembers: BoardMember[] = [
  ...
  {
    id: 'selasi-doku',
    name: 'Selasi Doku (Mrs.), MIoD-GH, Counselling psychologist |Life Strategist | Speaker',
    ...
    modalParagraphs: [
      ...
      'She holds a Master of Arts in Guidance and Counselling, a postgraduate certificate in psychology, and has completed training in trauma-informed care. Additionally, she has earned an executive certificate in counselling, a certificate in Women Entrepreneurship and Leadership for Africa Program (WELA) from the China Europe International Business School (CEIBS), where her contributions to the program have been recognised with “The most promising alumnus 2025 “, and she holds an Executive certificate in management.',
      'She is a member of the Institute of Directors in Ghana and the Ghana National Association of Certificated Counsellors (GNACC), where she serves as the Chairperson of the Continuing Professional Development Committee. She is also a member of the Ghana Psychological Association (GPA).',
  ...
  {
    id: 'seyram-mankra',
    name: 'Seyram Kodzo Mankra - Secretary',
    role: 'Member',
